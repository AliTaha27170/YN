    ...
    <div class="wwr-box">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <form action="{{ route('mainPush',['from'=>36 , 'to' =>37]) }}" method="POST">
                    {{ csrf_field() }}
                {{-- id=36 to 37    max 46 => النص  --}}
                <textarea class="textarea text   ar"  name="{{ $i }}">{{$text->find($i)-> ar}}</textarea>
                <textarea class="textarea text   en"  name="{{ $i.$i  }}" style="display:none"  >{{$text-> find($i++)-> en}} </textarea>
            ...
            <div data-aria-accordion data-transition id="accGen">
                ...
                <div data-aria-accordion-panel>
                    <p>
                        ...
                        حيث يمكنك أن تولد مثل هذا النص أو العديد هذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة، لقد
                        تم توليد هذا النص من مولد النص العربى، حيث يمكنك أن تولد مثل هذا النص أو العديد
                    </p>
                </div>
